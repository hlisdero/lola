...
view_gen_base_init_expression_list_class view_gen_base_init_expression_list;
...
impl_uviews uviews[] = {
    ...
    {"view_gen_base_init_expression_list",&view_gen_base_init_expression_list},
    {0,0}
};
...
\n\
\nabstract_phylum\
\nkc_create(enum_operators createOp, const std::ve"), kc_current_view );
		  kc_printer(kc_t("ctor<abstract_phylum>& kc_ps)\
\n{\
\n    if (kc_ps.size() < "), kc_current_view); }
		kc::unparse(j, kc_printer, kc_current_view);
		{ kc_printer(kc_t(") {\
\n        assertionFailed(\"Need vector of size of maximum subphylum count (which is "), kc_current_view); }
		kc::unparse(j, kc_printer, kc_current_view);
		{ kc_printer(kc_t(")!\");\
\n    }\
\n    return kc_create(createOp"), kc_current_view); }
		for (int i = 0; i < j; ++i) 
		{
		    { kc_printer(kc_t(", kc_ps["), kc_current_view); }
		    kc::unparse(i, kc_printer, kc_current_view);
		    { kc_printer(kc_t("]"), kc_current_view); }
		}
		{ kc_printer(kc_t(");\
...
\n#endif\
\n#ifndef REAL\
\n# define "), kc_current_view );
		  kc_printer(kc_t("REAL double\
\n#endif\
\n\
\n#ifdef KC_UNICODE\
\n\
...
\n"), kc_current_view );
		  kc_printer(kc_t("#define kc_strlen wcslen\
...
\n#define kc_print_integ"), kc_current_view );
		  kc_printer(kc_t("er(buf,number) swprintf(buf,kc_t(\"%d\"),number)\
\n#define kc_print_real(buf,number) swprintf(buf,kc_t(\"%g\"),number)\
\n\
\n// needed for printdot and csgio only\
\ninline\
\nstd::string kc_to_cstri"), kc_current_view );
		  kc_printer(kc_t("ng(const std::wstring& s) {\
\n    USES_CONVERSION;\
\n    return W2CA(s.c_str());\
\n}\
\n\
...
\n    USES_CONVE"), kc_current_view );
		  kc_printer(kc_t("RSION;\
\n    return A2CW(s.c_str());\
\n}\
\n\
\n#else // !defined(_WIN32) || defined(__GNUC__)\
\n// if you want to use UNICODE on other platforms you have to write\
\n// the following functions on y"), kc_current_view );
		  kc_printer(kc_t("our own\
...
\n"), kc_current_view );
		  kc_printer(kc_t("int kc_strncpy(kc_char_t*,const kc_char_t*, int);\
...
\n#endif\
\n\
\n#else "), kc_current_view );
		  kc_printer(kc_t("// !KC_UNICODE\
\n  \
...
\n#if defined(_WIN32) && ! "), kc_current_view );
		  kc_printer(kc_t("defined (__GNUC__)\
...
\n"), kc_current_view );
		  kc_printer(kc_t("#define kc_print_integer(buf,number) sprintf(buf,kc_t(\"%d\"),number)\
...
impl_arguments::do_unparse(printer_functor kc_printer, uview kc_current_view_base)
{
	...
	case view_gen_unparsedefs_default_c_enum: {
	    view_gen_unparsedefs_default_c_class& kc_current_view=static_cast<view_gen_unparsedefs_default_c_class&>(kc_current_view_base);
	    if ((this->arguments_1->prod_sel() == sel_Consarguments) && ((this->arguments_1)->arguments_1->prod_sel() == sel_Nilarguments) && (KC_TRACE_PROVIDED((kc_current_view.isList && kc_current_view.isOnlyDefault), "gen.k", 7429, this))) {
...
\n"), kc_current_view); }
		...
		if ((KC_TRACE_PROVIDED((kc_current_view.isList && !kc_current_view.isOnlyDefault), "gen.k", 7438, this))) {
		const ID a = this->ID_1;
...
impl_ac_constant_expression_list::do_unparse(printer_functor kc_printer, uview kc_current_view_base)
{
	...
	case view_gen_base_init_expression_list_enum: {
	    view_gen_base_init_expression_list_class& kc_current_view=static_cast<view_gen_base_init_expression_list_class&>(kc_current_view_base);
	    if ((this->ac_constant_expression_list_1->prod_sel() == sel_Nilac_constant_expression_list)) {
...
impl_ac_base_init_AcBaseInit::do_unparse(printer_functor kc_printer, uview kc_current_view_base)
{
	...
	case view_gen_fnk_c_enum: {
	    ...
	    {
		const ID id = this->ID_1;
		const ac_constant_expression_list expr = this->ac_constant_expression_list_1;
		kc::unparse(id, kc_printer, view_gen_fn_pointer_name);
		{ kc_printer(kc_t("("), kc_current_view); }
		kc::unparse(expr, kc_printer, view_gen_base_init_expression_list);
		{ kc_printer(kc_t(")"), kc_current_view); }
	    }
	    break;
	}
...
impl_charruns_Stars::do_unparse(printer_functor kc_printer, uview kc_current_view_base)
{
	...
	case base_uview_enum: {
	    uview kc_current_view=kc_current_view_base;
	    if ((KC_TRACE_PROVIDED((this->number>0), "gutil.k", 370, this))) {
		{ kc_printer(kc_t("*"), kc_current_view); }
		this->number--; 
