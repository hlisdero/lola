...
typedef enum {
    ...
    view_gen_base_init_expression_list_enum,
    last_uview
} uview_enum;
...
struct view_gen_base_init_expression_list_class: uview_class {
    view_gen_base_init_expression_list_class():uview_class(view_gen_base_init_expression_list_enum){}
};
extern view_gen_base_init_expression_list_class view_gen_base_init_expression_list;
